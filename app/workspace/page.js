...
const saveManualStats = async () => {
  ...
  >
    Update Stats
        ...
        <div style={metricBar}>
          <div style={metricBox}>
            <div style={metricLabel}>Full Down Assigned Volume</div>
            <div style={metricValueGreen}>{formatMoney(monthlyFullDownVolume)}</div>
          </div>

          <div style={metricBox}>
            <div style={metricLabel}>Pender Assigned Volume</div>
...
const yearStatsBox = { marginLeft: 'auto', background: '#0f172a', color: '#f9fafb', borderRadius: 18, padding: 16, minWidth: 520, display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 12, boxShadow: '0 16px 40px rgba(15,23,42,0.22)' }
